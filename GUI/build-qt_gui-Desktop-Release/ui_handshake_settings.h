...
public:
    ...
    void setupUi(QDialog *Handshake_settings)
    {
        if (Handshake_settings->objectName().isEmpty())
            Handshake_settings->setObjectName(QString::fromUtf8("Handshake_settings"));
        ...
        tv1_delay->setObjectName(QString::fromUtf8("tv1_delay"));
    ...
    {
        Handshake_settings->setWindowTitle(QApplication::translate("Handshake_settings", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Handshake_settings", "Mask", 0, QApplication::UnicodeUTF8));
        checkM1->setText(QApplication::translate("Handshake_settings", "M0", 0, QApplication::UnicodeUTF8));
        checkM2->setText(QApplication::translate("Handshake_settings", "M1", 0, QApplication::UnicodeUTF8));
        checkM3->setText(QApplication::translate("Handshake_settings", "M2", 0, QApplication::UnicodeUTF8));
        checkM4->setText(QApplication::translate("Handshake_settings", "M3", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("Handshake_settings", "tv1 delay (n*2.5 ns)", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
