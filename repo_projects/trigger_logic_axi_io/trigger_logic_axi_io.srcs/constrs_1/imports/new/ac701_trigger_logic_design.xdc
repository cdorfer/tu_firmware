...
## Input Triggers
set_property PACKAGE_PIN AC22 [get_ports {FASTOR_TRIG_IN[1]}]
...
set_property PACKAGE_PIN E26 [get_ports {LOGIC_DRS4_CH4[1]}]
...
set_property PACKAGE_PIN J18 [get_ports {PULSER_DRS4_CH4[1]}]
...
set_property PACKAGE_PIN E21 [get_ports TRIG_1]
set_property DRIVE 16 [get_ports TRIG_1]
set_property IOSTANDARD LVCMOS25 [get_ports TRIG_1]
set_property PACKAGE_PIN B22 [get_ports TRIG_2]
set_property DRIVE 16 [get_ports TRIG_2]
set_property IOSTANDARD LVCMOS25 [get_ports TRIG_2]
set_property PACKAGE_PIN AC17 [get_ports TRIG_3]
set_property DRIVE 16 [get_ports TRIG_3]
set_property IOSTANDARD LVCMOS25 [get_ports TRIG_3]


set_property PACKAGE_PIN H16 [get_ports {SCINTILLATOR_TRIG_IN[1]}]
set_property PACKAGE_PIN F23 [get_ports {DRS4_CH3[1]}]
set_property PACKAGE_PIN E25 [get_ports {PSI46_ATB_DTB[1]}]
set_property PACKAGE_PIN H26 [get_ports {PULSER_PREAMP_TP_TTL[1]}]

set_property PACKAGE_PIN Y18 [get_ports {PULSER_PREAMP_TP_SEL[1]}]
set_property PACKAGE_PIN B19 [get_ports {LOGIC_PREAMP_TP_SEL[1]}]

set_property PACKAGE_PIN AE25 [get_ports {FASTOR_TRIG_IN[5]}]

set_property PACKAGE_PIN AA15 [get_ports {BUSY_IN[2]}]
set_property PACKAGE_PIN Y15 [get_ports {BUSY_IN[3]}]
set_property PACKAGE_PIN G19 [get_ports {BEAM_CURRENT_IN[1]}]
set_property PACKAGE_PIN AD21 [get_ports {FASTOR_TRIG_IN[9]}]
set_property PACKAGE_PIN AC19 [get_ports {FASTOR_TRIG_IN[13]}]
set_property PACKAGE_PIN AD25 [get_ports {DIAMOND_TRIG_IN[1]}]
set_property PACKAGE_PIN H14 [get_ports {FASTOR_TRIG_IN[3]}]
set_property PACKAGE_PIN G17 [get_ports {FASTOR_TRIG_IN[7]}]
set_property PACKAGE_PIN AD23 [get_ports {FASTOR_TRIG_IN[11]}]
set_property PACKAGE_PIN AC18 [get_ports {FASTOR_TRIG_IN[15]}]
